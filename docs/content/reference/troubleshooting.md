...
Most of these come down to network reality or how mathreflect serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mathreflect rate-limits like any public site. mathreflect already paces
...
Where a surface is gated, mathreflect reads a cookie or token you supply
...
`mathreflect`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mathreflect actually did
