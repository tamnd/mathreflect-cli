...
```
mathreflect <command> [arguments] [flags]
```

Run `mathreflect <command> --help` for the full flag list on any command. This
...
per operation you declare in `mathreflect/domain.go`.
